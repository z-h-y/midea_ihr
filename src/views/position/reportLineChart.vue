<style lang="less">
  ...
  #position-chart-body{
    ...
    .position-direct-info,.position-dotted-info {
      // width:300px;
      // border:1px solid blue;
      float:right;
      height:30px;
    }
    .position-dotted-box,.position-direct-box {
      width:48px;
      height:24px;
      float:right;
      margin-top:1px;
    ...
    .position-direct-text,.position-dotted-text {
      width:150px;
      height:16px;
      line-height: 16px;
      margin-top:4px;
    ...
    // 图表样式
    @import url('../../static/lib/css/organizationChart.less');
  }
...
<panel class="panel-b content-wrap"  header="panel-header" id="position-chart-body">
    <div class="positionChart-header" >
      <div class="positionChart-selector-box">
        <v-form v-ref:positionChartForm :model="positionChart" :schema="positionChartSchema" label-width="100" label-suffix="" :cols="1" form-style="">
           <text-field property="positionName" type="selector" :readonly="true" :show.sync="show" editor-width="200"></text-field>
        </v-form>
      </div>
      <div class="positionChart-search-btn">
        <div class="position-relations-info" >
            <div class="position-direct-info">
                <p class="position-direct-text">Straight Line Report</p>
                <div class="position-direct-box"></div>
            </div>
            <div class="position-dotted-info">
              <p class="position-dotted-text">Dotted Line Report</p>
...
<ui-modal id="edit-indicator" :show.sync="showMoreInfo" type="large" :header="positionDetail.unitName" id="position-report-detail">
...
require('../../static/lib/js/positionChart.js');
// import PositionReportChart from '../../static/lib/js/jquery.orgchart.js';
    ...
    data() {
        ...
        events:{
                'selected-position': function(data) {//从选择器中获取参数
                    let positionId = data.positionId; // 获取职位ID
                    this.positionChart.positionName = data.positionName; //get position name from the selector
                    data.positionName;
