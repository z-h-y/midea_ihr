...
<div class="content-wrap fix ihr-position-title">
    <div class="group" id="group" style="height:40px;">
        <ui-button class="mr10 dis-tc btn-primary-bd" icon="fa-plus" color="primary" text="Add" :disabled="" @click="add" button-type="button"></ui-button>
        <ui-button class="mr10 dis-tc btn-default-bd" icon="fa-pencil-square-o" type="flat" text="Edit" :disabled="" @click="edit" button-type="button"></ui-button>
        <ui-button class="mr10 dis-tc btn-default-bd" icon="fa-remove" type="flat" text="Delete" :disabled="" @click="delete" button-type="button"></ui-button>
    ...
    <div class="tree-panel fix">
        ...
        <div class="help-desk treelist-detail" id="treelistDetail">
            <div class="vuetable-wrapper">
                <vuetable :api-url="titlesUrl" :selected-to="selectedRow" pagination-path="" table-wrapper=".vuetable-wrapper" :fields="titlesColumns" :item-actions="itemActions" per-page="10">
                </vuetable>
            </div>
        </div>
    </div>
...
export default {
    data() {
        let _self = this;
        return {
            delText: 'Are you sure to delete this job title?',
            selectedRow: [],
            jobGroup: {},
            show: {
    ...
    methods: {
        ...
        //     });
        //     e.srcElement.value = '';
        //     this.$http.post('/pos/standardJobs/importStandardJobInfo', formData).then(function(res) {
        //         Message({
        //             type: 'success',
