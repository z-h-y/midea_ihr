<template>
    <div class="ui-calendar" :class="classes">
        <div class="ui-calendar-header">
            ...
            <div
                class="ui-calendar-header-details"
                tabindex="0"
            ...
            >
                <span class="ui-calendar-header-day">{{ headerDay }}, </span>
                <span class="ui-calendar-header-date">{{ headerDate }}</span>
            </div>
        </div>

        <div class="ui-calendar-body">
            <ul class="ui-calendar-years" ref="years" v-show="showYearPicker">
                <li
                    class="ui-calendar-year"
                    tabindex="0"
            ...
            <div class="ui-calendar-footer" v-if="$slots.footer">
