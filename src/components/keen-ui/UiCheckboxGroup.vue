<template>
    <div class="ui-checkbox-group" :class="classes">
        <div class="ui-checkbox-group-label-text" v-if="label || $slots.default">
            <slot>{{ label }}</slot>
        </div>

        <div class="ui-checkbox-group-checkboxes">
            <ui-checkbox
                class="ui-checkbox-group-checkbox"
        ...
        <div class="ui-checkbox-group-feedback" v-if="hasFeedback">
            <div class="ui-checkbox-group-feedback-text" v-if="showError">
                <slot name="error">{{ error }}</slot>
            </div>

            <div class="ui-checkbox-group-feedback-text" v-else-if="showHelp">
...
.ui-checkbox.ui-checkbox-group-checkbox {
    margin-bottom: 0;
