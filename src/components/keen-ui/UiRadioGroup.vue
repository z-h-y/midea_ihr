<template>
    <div class="ui-radio-group" :class="classes">
        <div class="ui-radio-group-label-text" v-if="label || $slots.default">
            <slot>{{ label }}</slot>
        </div>

        <div class="ui-radio-group-radios">
            <ui-radio
                class="ui-radio-group-radio"
        ...
        <div class="ui-radio-group-feedback" v-if="hasFeedback">
            <div class="ui-radio-group-feedback-text" v-if="showError">
                <slot name="error">{{ error }}</slot>
            </div>

            <div class="ui-radio-group-feedback-text" v-else-if="showHelp">
