<template>
    <li class="ui-autocomplete-suggestion" :class="classes">
        <slot>
            <div class="ui-autocomplete-suggestion-simple" v-if="type === 'simple'">
                {{ suggestion[keys.label] || suggestion }}
            </div>

            <div class="ui-autocomplete-suggestion-image" v-if="type === 'image'">
                <div class="ui-autocomplete-suggestion-image-object" :style="imageStyle"></div>
                <div
                    class="ui-autocomplete-suggestion-image-text"
...
.ui-autocomplete-suggestion-image {
    @include text-truncation;
    align-items: center;
    display: flex;
}

.ui-autocomplete-suggestion-image-object {
