<template>
    <div class="ui-autocomplete" :class="classes">
        <div class="ui-autocomplete-icon-wrapper" v-if="icon || $slots.icon">
            <slot name="icon">
        ...
        <div class="ui-autocomplete-content">
            <label class="ui-autocomplete-label">
                <div
                    class="ui-autocomplete-label-text"
                    :class="labelClasses"
                ...
                <ui-icon
                    class="ui-autocomplete-clear-button"
                    title="Clear"
            ...
            <div class="ui-autocomplete-feedback" v-if="hasFeedback">
                <div class="ui-autocomplete-feedback-text" v-if="showError">
                    <slot name="error">{{ error }}</slot>
                </div>

                <div class="ui-autocomplete-feedback-text" v-else-if="showHelp">
...
.ui-autocomplete {
    ...
    &.is-active:not(.is-disabled) {
        .ui-autocomplete-label-text,
        .ui-autocomplete-icon-wrapper .ui-icon {
