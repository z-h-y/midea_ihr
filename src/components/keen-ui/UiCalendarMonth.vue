<template>
    <div class="ui-calendar-month">
        <div class="ui-calendar-month-header">
            <span v-for="day in lang.days.initials">{{ day }}</span>
        </div>

        <div
            class="ui-calendar-month-week is-current"
            ref="current"
        ...
        <div class="ui-calendar-month-week is-other" ref="other" :class="weekClasses">
            <ui-calendar-week
                :key="index"
                :max-date="maxDate"
                :min-date="minDate"
