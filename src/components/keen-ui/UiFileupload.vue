<template>
    ...
    >
        ...
        <div class="ui-fileupload-content">
            ...
            <span v-if="hasSelection" class="ui-fileupload-display-text">{{ displayText }}</span>
            <slot v-else>{{ placeholder }}</slot>
        </div>

        <div class="ui-fileupload-focus-ring" :style="focusRingStyle"></div>
