<template>
    <div class="ui-datepicker" :class="classes">
        <input
            class="ui-datepicker-hidden-input"
            type="hidden"
        ...
        <div class="ui-datepicker-icon-wrapper" v-if="icon || $slots.icon">
            <slot name="icon">
        ...
        <div class="ui-datepicker-content">
            ...
            >
                <div
                    class="ui-datepicker-label-text"
                    :class="labelClasses"
                ...
                <div class="ui-datepicker-display">
                    <div
                        class="ui-datepicker-display-value"
                        :class="{ 'is-placeholder': !hasDisplayText }"
                    >
                        {{ hasDisplayText ? displayText : (hasFloatingLabel && isLabelInline) ? null : placeholder }}
                    </div>

                    <ui-icon class="ui-datepicker-dropdown-button" v-if="usesPopover && !disabled">
            ...
            <div class="ui-datepicker-feedback" v-if="hasFeedback">
                <div class="ui-datepicker-feedback-text" v-if="showError">
                    <slot name="error">{{ error }}</slot>
                </div>

                <div class="ui-datepicker-feedback-text" v-else-if="showHelp">
        ...
        >
            ...
            >
                <div class="ui-datepicker-modal-buttons" slot="footer">
                    <ui-button
                        type="secondary"
                        :color="color"
...
.ui-datepicker {
    ...
    &.is-active:not(.is-disabled) {
        .ui-datepicker-label-text,
        .ui-datepicker-icon-wrapper .ui-icon {
    ...
    &.is-disabled {
        ...
        .ui-datepicker-dropdown-button,
        .ui-datepicker-display-value.is-placeholder {
            color: $ui-input-text-color-disabled;
    ...
    .ui-modal:not(.has-footer) .ui-modal-body {
        padding: 0;
